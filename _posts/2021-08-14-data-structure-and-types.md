...
#### 2. Tree
Tương tự một `graph`, một `Tree` là tập hợp của các đỉnh và các cạnh. Tuy nhiên, trong cấu trúc dữ liệu cây, chỉ có thể có 1 cạnh giữa 2 đỉnh.
...
Bây giờ, chúng ta biết về tuyến tính và phi tuyến tính, chúng ta sẽ xem sự khác biệt giữa chúng.
